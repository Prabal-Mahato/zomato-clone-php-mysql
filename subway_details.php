...
<style type="text/css">
	.jumbotron{
		background-image: url('https://www.designmantic.com/blog/wp-content/uploads/2016/08/SubWayNewLogo.png');
...
<div class="container">
	<div class="row">
	<?php
	$query = "SELECT * FROM products WHERE category LIKE '%Subway%'";

...
<div class="container">
	<div class="row">
		...
		<div class="col-6">
			<h2 class="mt-5 ml-5">My Orders</h2><br>
						...
						$query2 = "SELECT * FROM `order_details` o JOIN `products` a ON o.`product_id` = a.`product_id` WHERE  o.`order_id`= '$curr_order_id'";
						$result2 = mysqli_query($conn,$query2);
						while($row2 = mysqli_fetch_assoc($result2))
						{
							echo '<div class="col-3 mb-3">
							<img src="'.$row2['bg'].'" style="width: 100%;height: 50px">
						</div>

...
<style type="text/css">
	.jumbotron{
		background-image: url('https://www.kindpng.com/picc/m/618-6183551_vxeqndzqrqcr9xgv830y-white-logo-arsalan-biryani-logo-hd-png.png');
...
<div class="container">
	<div class="row">
	<?php
	$query = "SELECT * FROM products WHERE category LIKE '%Arsalan%'";

...
<style type="text/css">
	.jumbotron{
		background-image: url('https://www.dineout.co.in/blog/wp-content/uploads/2020/07/Flavours-of-North_Blog.jpg');
...
<div class="container">
	<div class="row">
	<?php
	$query = "SELECT * FROM products WHERE category LIKE '%Zip Zap%'";
